...
public class RadarRestController {
    ...
    public RadarRestController(RadarRepository radarRepository, ImmatriculationFeignClient immatriculationFeignClient, InfractionFeignClient infractionFeignClient) {
    ...
    public List<Radar> getRadars(){
        ...
        for(Radar radar : radars){
            ...
            for(Infraction infraction : infractions){
                Vehicle vehicle = immatriculationFeignClient.getVehicle(infraction.getVehicleId());
    ...
    public Radar updateRadar(@PathVariable("id") Long id,@RequestBody Radar radar){
        if(radarRepository.existsById(id)){
            ...
            if(radar.getVitesseMax() != null) savedRadar.setVitesseMax(radar.getVitesseMax());
